...
def packRegisterParam():
    ...
    biz['password'] = str(security.encrypt(b'123456'), 'utf-8')
...
class gatlin(unittest.TestCase):
    ...
    def setUpClass(self):
        print('STARTING...')
        self.ENV = "DEV"  # ~~~~~~~~~~~~~~~~~~~~~~这里改环境!!!~~~~~~~~~~~~~~~~~~~~~~
        security.init(self.ENV)  # 初始化加密的公私钥，将来可以把token也塞入类的成员变量
        self.context = {}  # 初始化上下文
